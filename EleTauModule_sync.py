...
class EleTauProducer(Module):
    ...
    def __init__(self, name, DataType):
        ...
        self.out.trg_singleelectron           = num.zeros(1, dtype=int)
        self.out.tree.Branch('trg_singleelectron'             , self.out.trg_singleelectron, 'trg_singleelectron/I')
...
#            return False
        ...
        for ielectron in range(event.nElectron):
            ...
            if event.Electron_pt[ielectron] < 25: continue
...
#        print 'pZetaVis = ', pZetaVis_, ' pZetaMET = ', pZetaMET_                                                                                           
        ...
        self.out.trg_singleelectron[0] = event.HLT_Ele35_WPTight_Gsf
