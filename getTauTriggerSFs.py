...
path = '/shome/ytakahas/work/Leptoquark/CMSSW_9_4_4/src/PhysicsTools/NanoAODTools/NanoTreeProducer/TauTriggerSFs2017/data'
...
class getTauTriggerSFs :
    ...
    def __init__( self, tauMVAWP='medium' ):
        ...
        self.f = ROOT.TFile( path + '/tauTriggerEfficiencies2017.root', 'r' )
